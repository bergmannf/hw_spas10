...
CREATE TABLE IF NOT EXISTS `fhb2`.`authors` (
...
CREATE TABLE IF NOT EXISTS `fhb2`.`customers` (
  ...
  `C_USERNAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `C_PASSWORD` varbinary(250) NOT NULL,
  PRIMARY KEY (`C_ID`),
...
CREATE TABLE IF NOT EXISTS `fhb2`.`items` (
