...
\newcommand{\myDegree}{Assessment Three: MACS bookstore\xspace}
...
\newcommand{\sourceRoot}{../}
\newcommand{\myPackage}{}
\newcommand{\myJPackage}{}
\newcommand{\sourcePackage}[2]{\subsection*{Project: #2}\renewcommand{\myPackage}{#1}\renewcommand{\myJPackage}{#2}}

\newcommand{\siteRoot}{../}
\newcommand{\includeRoot}{../Includes/}
\newcommand{\sourceClass}[2]{\lstinputlisting[caption=#1]{\sourceRoot\myPackage/#2}}
...
\lstset{
    ...
    stringstyle=\color{red}	\mdseries,
    numbers=left,%left,%
